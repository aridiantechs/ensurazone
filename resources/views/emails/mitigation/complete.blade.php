      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          ...
          <td valign="top" class="bg_white" style="padding: 1em 2.5em 0 2.5em;">
          	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          		<tr>
          			<td class="logo">
			            <h1 style="text-align: center"><a href="#" style="text-align: center">Ensurazone</a></h1>
			          </td>
          		</tr>
          	</table>
          </td>
        ...
        <tr>
          <td valign="top" class="bg_white" style="padding: 1em 2.5em;">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td>
                  <p style="margin-left: 1.7rem">Your Mitigation Report has been completed you can view it on the given link: <br>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-right: 10px;">
                        <p>&copy; 2020 Ensurazone. All Rights Reserved</p>
                      </td>
                    </tr>
                  </table>
                </td>
