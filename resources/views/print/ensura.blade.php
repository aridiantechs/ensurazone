...
<head>
    ...
    <style type="text/css">
        ...
        li.testimonal__list-item.slick-slide.slick-active:nth-child(1) {
        ...
        .middle-testimonial .single-testimonial {
        ...
        .slick-active:not(.middle-testimonial) .single-testimonial{
            padding: 30px;
            margin-top: 45px;
        }
                            ...
                            <div class="col-sm-10 col-centered">
                                <div class="single-talent mb-5" style="font-size: 1.6rem;">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-md-12">
                                        <img src="{{asset('images/sattelite.png')}}" style="width: 100%" alt="">
                                      </div>
                                    </div>
                                      ...
                                      <div class="col-md-12">
                                        <table style="width: 100%">
                                          ...
                                          <tr>
                                            ...
                                            <th style="border: 1px solid;">
                                              <table>
                                                <tr style="border-bottom: 1px solid;"><th><h4 class="ml-3"><b style="color: red">Exposed firewood beside the store </b></h4></th></tr>
                                                <tr style="border-bottom: 1px solid;"><th><h4 class="ml-3"><b style="color: red">Scrape of rubber tires found beside the outdoor barbeque area </b></h4></th></tr>
                                                <tr style="border-bottom: 1px solid;"><th><h4 class="ml-3"><b style="color: red">None  </b></h4></th></tr>
                                                <tr style="border-bottom: 1px solid;"><th><h4 class="ml-3"><b style="color: red">Found </b></h4></th></tr>
                                                <tr style="border-bottom: 1px solid;"><th><h4 class="ml-3"><b style="color: red">*The length of grass is 5” high from the surface</b></h4></th></tr>
                                          ...
                                          <tr>
                                            <th style="border: 1px solid;">
                                              <table>
                                                <tr>
                                                  ...
                                                  <th style="border-left: 1px solid;">
                                                    <table style="width: 100%">
                                                      <tr style="border-bottom: 1px solid;"><th><h4 class="ml-3">Gutters</h4></th></tr>
                                                      <tr style="border-bottom: 1px solid;"><th><h4 class="ml-3">Porch </h4></th></tr>
                                                      <tr style="border-bottom: 1px solid;"><th><h4 class="ml-3"><b>Roofline </b></h4></th></tr>
                                                      <tr><th><h4 class="ml-3"><b>Deck</b></h4></th></tr>
                                                    </table>
                                                  </th>
                                                </tr>
                                              </table>
                                            ...
                                            <th style="border: 1px solid;">
                                              <table>
                                                <tr style="border-bottom: 1px solid;"><th><h4 class="ml-3">Clear</h4></th></tr>
                                                <tr style="border-bottom: 1px solid;"><th><h4 class="ml-3">Clear</h4></th></tr>
                                                <tr style="border-bottom: 1px solid;"><th><h4 class="ml-3"><b style="color: red">Lots of pine needles found at the back of the side on the roof-line  </b></h4></th></tr>
                                                <tr><th><h4 class="ml-3"><b style="color: red">Dry leaves found </b></h4></th></tr>
                                              </table>
                                            </th>
                                          ...
                                          <tr>
                                            <th style="border: 1px solid;">
                                              <table>
                                                <tr>
                                                  ...
                                                  <th style="border-left: 1px solid;">
                                                    <table style="width: 100%">
                                                      <tr style="border-bottom: 1px solid;"><th><h4 class="ml-3">Attic </h4></th></tr>
                                                      <tr style="border-bottom: 1px solid;"><th><h4 class="ml-3">Chimney  </h4></th></tr>
                                                      <tr style="border-bottom: 1px solid;"><th><h4 class="ml-3"><b>Soffit vent </b></h4></th></tr>
                                                      <tr><th><h4 class="ml-3"><b>Foundation vent</b></h4></th></tr>
                                                    </table>
                                                  </th>
                                                </tr>
                                              </table>
                                            ...
                                            <th style="border: 1px solid;">
                                              <table>
                                                <tr style="border-bottom: 1px solid;"><th><h4 class="ml-3">Screen missing and there is a nest of the birds</h4></th></tr>
                                                <tr style="border-bottom: 1px solid;"><th><h4 class="ml-3">Screen Covered </h4></th></tr>
                                                <tr style="border-bottom: 1px solid;"><th><h4 class="ml-3"><b style="color: red">Front soffit vent is broken</b></h4></th></tr>
                                                <tr><th><h4 class="ml-3"><b style="color: red">Screen covered </b></h4></th></tr>
                                              </table>
                                            </th>
                                        ...
                                        <table style="width: 100%">
                                          ...
                                          <tr>
                                            <th style="border: 1px solid;">
                                              <table style="width: 100%;">
                                                <tr>
                                                  <th style="width: 47%;"><h4 class="ml-3">No. of trees </h4>
                                                  </th>
                                                  <th style="border-left: 1px solid;">
                                                    <table>
                                                      <tr><th><h4 class="ml-3">4</h4></th></tr>
                                                    </table>
                                                  </th>
                                                </tr>
                                              </table>
                                          ...
                                          <tr>
                                            <th style="border: 1px solid;">
                                              <table style="width: 100%;">
                                                <tr>
                                                  <th style="width: 47%;"><h4 class="ml-3">Density of trees</h4>
                                                  </th>
                                                  <th style="border-left: 1px solid;">
                                                    <table>
                                                      <tr><th><h4 class="ml-3">medium </h4></th></tr>
                                                    </table>
                                                  </th>
                                                </tr>
                                              </table>
                                          ...
                                          <tr>
                                            <th style="border: 1px solid;">
                                              <table style="width: 100%;">
                                                <tr>
                                                  <th style="width: 47%;"><h4 class="ml-3">Distance of trees from the structure</h4>
                                                  </th>
                                                  <th style="border-left: 1px solid;">
                                                    <table>
                                                      <tr><th><h4 class="ml-3">5ft apart from the kitchen </h4></th></tr>
                                                    </table>
                                                  </th>
                                                </tr>
                                              </table>
                                          ...
                                          <tr>
                                            <th style="border: 1px solid;">
                                              <table style="width: 100%;">
                                                <tr>
                                                  <th style="width: 47%;"><h4 class="ml-3"><b>Arrangement of trees</b></h4>
                                                  </th>
                                                  <th style="border-left: 1px solid;">
                                                    <table>
                                                      <tr><th><h4 class="ml-3"><b>Clustered </b></h4></th></tr>
                                                    </table>
                                                  </th>
                                                </tr>
                                              </table>
                                            </th>
                                            <th style="border: 1px solid;"><h4 class="ml-3"><b> Cluster size=2</b></h4></th>
                                          ...
                                          <tr>
                                            <th style="border: 1px solid;">
                                              <table style="width: 100%;">
                                                <tr>
                                                  <th style="width: 47%;"><h4 class="ml-3">Location(directions)</h4>
                                                  </th>
                                                  <th style="border-left: 1px solid;">
                                                    <table>
                                                      <tr><th><h4 class="ml-3"><b>(list of all trees found in all dimensions )</b></h4></th></tr>
                                                    </table>
                                                  </th>
                                                </tr>
                                              </table>
                                          ...
                                          <tr>
                                            <th style="border: 1px solid;">
                                              <table style="width: 100%;">
                                                <tr>
                                                  <th style="width: 47%;"><h4 class="ml-3">Other factors</h4>
                                                  </th>
                                                  <th style="border-left: 1px solid;">
                                                    <table>
                                                      <tr><th><h4 class="ml-3">Comments of the SME regarding vegetation arrangement, number and the location of the trees</h4></th></tr>
                                                    </table>
                                                  </th>
                                                </tr>
                                              </table>
                                            ...
                                            <th style="border: 1px solid;"><h4 class="ml-3"><b></b></h4></th>
                                            <th style="border: 1px solid;"><h4 class="ml-3">Two lemon trees located aligned in north western direction may have a chance of  becoming ladder fuel <b>*Photograph</b></h4></th>
                                          </tr>
                                          <tr>
                                      ...
                                      <div class="col-md-12">
                                        <table style="width: 100%">
                                          ...
                                          <tr>
                                            ...
                                            <th style="border: 1px solid;">
                                              <table>
                                                <tr><th><h4 class="ml-3">defensible space does not extend onto a neighboring property</h4></th>
                                                </tr>
                                                <tr>
                                                  <th style="border: 1px solid;width: 50%;"><h4 class="ml-3">low limbed conifers</h4></th>
                                                  <th style="border: 1px solid;"><h4 class="ml-3"></h4></th>
                                                </tr>
                                              </table>
                                            </th>
                                          ...
                                          <tr>
                                            ...
                                            <th style="border: 1px solid;"><h4 class="ml-3">(count) exp. 15</h4></th>
                                            <th style="border: 1px solid;"></th>
                                          </tr>
                                          <tr>
                                            <th style="border: 1px solid;"><h4 class="ml-3">Density of trees</h4></th>
                                            <th style="border: 1px solid;"><h4 class="ml-3">high </h4></th>
                                            <th style="border: 1px solid;"></th>
                                          </tr>
                                          <tr>
                                            <th style="border: 1px solid;"><h4 class="ml-3">Site view</h4></th>
                                            <th style="border: 1px solid;"><h4 class="ml-3">(Photograph from the site) </h4></th>
                                            <th style="border: 1px solid;"></th>
                                          </tr>
                                          <tr>
                                            <th style="border: 1px solid;"><h4 class="ml-3"><b>Arrangement </b></h4></th>
                                            <th style="border: 1px solid;"><h4 class="ml-3">Continues </h4></th>
                                          ...
                                          <tr>
                                            ...
                                            <th style="border: 1px solid;"><h4 class="ml-3">Trees are scattered by Less than 10ft distance in different directions </h4></th>
                                          ...
                                          <tr>
                                            ...
                                            <th style="border: 1px solid;"><h4 class="ml-3">4  </h4></th>
                                          ...
                                          <tr>
                                            ...
                                            <th style="border: 1px solid;"><h4 class="ml-3">Branches of 6 trees are 4ft high from the surface in different direction</h4></th>
                                            <th style="border: 1px solid;"><h4>The branches of trees should be above 6ft high from the surface </h4></th>
                                          </tr>
                                          <tr>
