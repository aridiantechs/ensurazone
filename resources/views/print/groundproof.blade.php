                            ...
                            <div class="col-sm-10 col-centered">
                                <div class="single-talent mb-5" style="font-size: 1.6rem;">
                                    ...
                                    <div class="row mt-5">
                                      <div class="col-xs-4 col-sm-4 col-md-4">
                                        <table style="width:100%">
                                            <tr>
                                                <th>Name</th>
                                                <td>{{$finding->ground_proof->user->name ?? ''}}</td>
                                            </tr>
                                        </table>
                                      </div>
                                      <div class="col-xs-4 col-sm-4 col-md-4">
                                        <table style="width:100%">
                                            <tr>
                                                <th>Customer ID</th>
                                                <td>{{$finding->ground_proof->user->customer_id ?? ''}}</td>
                                            </tr>
                                        </table>
                                      </div>
                                      <div class="col-xs-4 col-sm-4 col-md-4">
                                        <table style="width:100%">
                                            <tr>
                                                ...
                                                <td>{{$finding->ground_proof->created_at ?? ''}}</td>
                                            </tr>
                                        </table>
                                      </div>
                                      <div class="col-xs-4 col-sm-4 col-md-4">
                                        <table style="width:100%">
                                            <tr>
                                                <th>Contact#</th>
                                                <td>{{$finding->ground_proof->user->remote_assessment->phone ?? ''}}</td>
                                            </tr>
                                        </table>
                                      </div>
                                      <div class="col-xs-4 col-sm-4 col-md-4">
                                        <table style="width:100%">
                                            <tr>
                                                <th>Email ID</th>
                                                <td><a href="#">{{$finding->ground_proof->user->email ?? ''}}</a></td>
                                            </tr>
                                        </table>
                                      </div>
                                      <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                                        <table style="width:100%">
                                            <tr>
                                                <th>Address </th>
                                                <td>{{$finding->ground_proof->user->remote_assessment->address1 ?? ''}}</td>
                                            </tr>
                                        </table>
                                      </div>
                                    </div>
                                    ...
                                    <div class="row mt-5">
                                      ...
                                      <div class="col-md-12">
                                        <table style="width: 100%">
                                          ...
                                          <tr>
                                            ...
                                            @php
                                              $veg_remarks=$survey->where('key','veg_remarks')->first();
                                          ...
                                          <tr>
                                            ...
                                            <th style="border: 1px solid;">
                                              @php
                                                $logs_woodpile_value=$survey->where('key','logs_woodpile_value')->first();
                                                $scrape_value=$survey->where('key','scrape_value')->first();
                                                $flammable_value=$survey->where('key','flammable_value')->first();
                                                $wild_grass_value=$survey->where('key','wild_grass_value')->first();
                                                $conifer_value=$survey->where('key','conifer_value')->first();
                                              @endphp
                                              <table>
                                          ...
                                          <tr>
                                            ...
                                            <th style="border: 1px solid;">
                                              @php
                                                $Gutters_value=$survey->where('key','Gutters_value')->first();
                                                $roof_line_value=$survey->where('key','roof_line_value')->first();
                                                $porch_value=$survey->where('key','porch_value')->first();
                                                $deck_value=$survey->where('key','deck_value')->first(); 
                                              @endphp
                                              <table>
                                          ...
                                          <tr>
                                            ...
                                            <th style="border: 1px solid;">
                                              @php
                                                $screen_attic_value=$survey->where('key','screen_attic_value')->first();
                                                $screen_soffit_value=$survey->where('key','screen_soffit_value')->first();
                                                $screen_foundation_value=$survey->where('key','screen_foundation_value')->first();
                                                $screen_chimney_value=$survey->where('key','screen_chimney_value')->first(); 
                                              @endphp
                                              <table>
                                      ...
                                      <div class="col-md-12">
                                        @php
                                          $space_assess1_trees=$survey->where('key','space_assess1_trees')->first();
                                          $space_assess1_trees_distance=$survey->where('key','space_assess1_trees_distance')->first();
                                          $space_assess1_density=$survey->where('key','space_assess1_density')->first();
                                          $space_assess1_space_arrangement=$survey->where('key','space_assess1_space_arrangement')->first(); 
                                          $location=$survey->where('key','location')->first();
                                          $space_assess1_img=$survey->where('key','space_assess1_img')->first();
                                          $space_assess1_img_description=$survey->where('key','space_assess1_img_description')->first();
                                          $space_assess2_sme_comments=$survey->where('key','space_assess2_sme_comments')->first();
                                        @endphp
                                        <table style="width: 100%">
                                          <tr>
                                            <th style="border-left: 1px solid;"><h4 class="ml-3"><b>Vegetation </b></h4></th>
                                      ...
                                      <div class="col-md-12">
                                        @php
                                          $space_assess2_trees=$survey->where('key','space_assess2_trees')->first();
                                          $space_assess2_trees_density=$survey->where('key','space_assess2_trees_density')->first();
                                          $space_assess2_density=$survey->where('key','space_assess2_density')->first();
                                          $space_assess2_space=$survey->where('key','space_assess2_space')->first(); 
                                          $space_assess2_clumpsize=$survey->where('key','space_assess2_clumpsize')->first();
                                          $space_assess2_ladder_fuel=$survey->where('key','space_assess2_ladder_fuel')->first();
                                          $space_assess2_neighbour_vege=$survey->where('key','space_assess2_neighbour_vege')->first();
                                          $space_assess2_site_findings=$survey->where('key','space_assess2_site_findings')->first();
                                          $space_assess2_slope=$survey->where('key','space_assess2_slope')->first();
                                          $space_assess2_aspects=$survey->where('key','space_assess2_aspects')->first();
                                          $space_assess2_rock=$survey->where('key','space_assess2_rock')->first();
                                          $space_assess2_sme_comments=$survey->where('key','space_assess2_sme_comments')->first();
                                          $space_assess2_img=$survey->where('key','space_assess2_img')->first();
                                        @endphp
                                        <table style="width: 100%">
                                          <tr>
                                            <th style="border-left: 1px solid;"><h4 class="ml-3"><b>Vegetation </b></h4></th>
