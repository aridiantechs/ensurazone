                                ...
                                <td>
                                    <span class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            @if (auth()->user()->hasRole('superadmin') && $user->ground_proof->status != "completed")
                                                <a class="dropdown-item" name="ground_proof_assign" data-gpid="{{$user->ground_proof->id}}" href="#" data-toggle="modal" data-target="#enz_AssignContract"><i class="la la-list"></i> Assign Inquiry</a>
                                            @endif
                                    ...
                                    @if ($user->ground_proof->status =="completed")
                                       <a href="{{ route('backend.ground_proof.download',$user->ground_proof->id) }}" target="_blank" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Download Report">
